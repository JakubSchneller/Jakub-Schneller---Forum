...
class Templatec1255fe2d7 extends Latte\Runtime\Template
{
	...
	{
		extract($this->params);
		if (isset($this->params['comment'])) trigger_error('Variable $comment overwritten in foreach on line 257');
...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <!-- Title -->
                <h1 class="mt-4"><?php echo LR\Filters::escapeHtmlText($post->post_name) /* line 234 */ ?></h1>

                <!-- Author -->
                <p class="lead">
                    <?php echo LR\Filters::escapeHtmlText($post->post_description) /* line 238 */ ?>
		...
		echo LR\Filters::escapeHtmlText($post->post_creator) /* line 246 */ ?></a> <?php echo LR\Filters::escapeHtmlText($post->post_date) /* line 246 */ ?></p></strong>

                <hr>

                <!-- Post Content -->
                <font size="4"><?php echo LR\Filters::escapeHtmlText($post->post_content) /* line 251 */ ?></font>
                <br>
                <br>
                <br>
                            <h3>Komentáře</h3>
...
?>
                        <div class="col-sm-1">
                            <div class="thumbnail">
                                <img class="img-responsive user-photo" src="../<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($comment['dbrow']->creator_image)) /* line 260 */ ?>">
                            </div><!-- /thumbnail -->
                        </div><!-- /col-sm-1 -->
			...
			echo LR\Filters::escapeHtmlText($comment['dbrow']->creator_name) /* line 267 */ ?></a></strong>
                                        <span class="right" class="text-muted">
                                            Přidáno <?php echo LR\Filters::escapeHtmlText($comment['age']) /* line 269 */ ?>

                                        </span>
                                </div>
                                <div class="panel-body">
                                    <?php echo LR\Filters::escapeHtmlText($comment['dbrow']->content) /* line 273 */ ?>

		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					...
					<li ><a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Forum:categories")) ?>">Forum</a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
<?php
		if ($user->isLoggedIn()) {
			?>						<li><a  href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Profile:profile")) ?>">Přihlášen jako: <?php
			echo LR\Filters::escapeHtmlText($loggedin_name) /* line 18 */ ?></a></li>
